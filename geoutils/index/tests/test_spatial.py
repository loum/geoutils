...
class TestSpatial(unittest2.TestCase):
    ...
    def test_get_reverse_timestamp(self):
        ...
        """
        received = self._spatial.get_reverse_timestamp('19961217102630')
        expected = '09222521218464775807'
        msg = 'Reverse timestamp error'
        self.assertEqual(received, expected, msg)

        newer = self._spatial.get_reverse_timestamp('19971217102630')
    ...
    def test_get_reverse_timestamp_current_time(self):
        ...
        """
        received = self._spatial.get_reverse_timestamp()
    ...
    def test_get_reverse_timestamp_invalid_source_utc_length(self):
        ...
        """
        received = self._spatial.get_reverse_timestamp('199612171026')
    ...
    def test_get_reverse_timestamp_invalid_source_unknown_delimeter(self):
        ...
        """
        received = self._spatial.get_reverse_timestamp('1996121710--')
